...
struct commandHelp {
  ...
  char *since;
    ...
    "1.0.5" },
    { "ZRANGEBYSCORESTORE",
    "destination key min max [LIMIT offset count]",
    "splice a range of members in a sorted set into a new key",
    4,
    "3.0.0" },
    { "ZRANK",
    "key member",
    ...
    "destination key min max [LIMIT offset count]",
    "splice a range of members in a sorted set into a new key ordered from high to low",
    4,
    "3.0.0" },
    { "ZREVRANK",
    "key member",
    ...
    "2.0.0" },
    { "ZUNION",
    "destination numkeys key [key ...] [WEIGHTS weight] [AGGREGATE SUM|MIN|MAX] [WITHSCORES]",
    "Add multiple sorted sets and return result array",
    4,
    "3.0.0" }
};
